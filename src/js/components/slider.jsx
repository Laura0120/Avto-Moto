      ...
      <div className="slider__image-active-wrapper">
        <picture>
          <source
            ...
            srcSet={`${MAIN_URL}${desktopWebp}`}
          />
          <source
            type="image/webp"
            media="(min-width: 768px)"
            srcSet={`${MAIN_URL}${tabletWebp}`}
          />
          <source type="image/webp" srcSet={`${MAIN_URL}${mobileWebr}`} />
          <source media="(min-width: 1223px)" srcSet={`${MAIN_URL}${desktopJpg}`} />
          <source media="(min-width: 768px)" srcSet={`${MAIN_URL}${tabletJpg}`} />
          <img
            src={`${MAIN_URL}${mobileJpg}`}
            loading="lazy"
