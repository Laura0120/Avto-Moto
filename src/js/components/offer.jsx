...
const Offer = () => {
  return (
    <section className='page-content__offer offer'>
      ...
      <button type='button' className='offer__button offer__button--application'>оставить заявку</button>
      <button type='button' className='offer__button offer__button--credit'>в кредит от 11 000 ₽</button>
    </section>
  );
};
